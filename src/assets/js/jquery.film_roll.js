...
(function() {
  ...
  this.FilmRoll = (function() {
    ...
    FilmRoll.prototype.configure = function() {
      ...
      this.mouse_catcher = jQuery(
        '<div style="position:absolute; top:0; left: 0; height: 100%; width: 100%;" class="film_roll_mouse_catcher"></div>'
      );
    ...
    FilmRoll.prototype.moveToIndex = function(index, direction, animate) {
      ...
      jQuery(child)
        .addClass('active')
        .trigger(jQuery.Event('film_roll:activate'));
